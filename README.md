...
## Live Demo
View the analysis as an interactive web page: [World Happiness Analysis](https://venkatesh188.github.io/World-Happiness-Analysis/)
...
```
World-Happiness-Analysis/
├── World-Happiness-Analysis.html  # Main analysis page
